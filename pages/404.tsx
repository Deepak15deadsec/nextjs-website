  ...
  return (
    <div className="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
      <div className="max-w-md">
        ...
        <button
          onClick={() => router.back()}
          className="sm:w-full lg:w-auto my-2 border rounded md py-4 px-8 text-center bg-maingreen text-black hover:bg-opacity-95 focus:outline-none"
        >
          Go back!
        </button>
      </div>
      <div>
        <svg
          className="h-72 w-72 lg:h-96 lg:w-96 text-white cursor-pointer"
