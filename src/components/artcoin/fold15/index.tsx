  ...
  return (
    <div className="w-full bg-[#F5F5F5]">
      ...
      <div className="bg-[#F5F5F5] mt-[0rem]  flex flex-col justify-center items-center md:px-[2rem] lg:px-[4rem] px-[4rem]">
        <p className="text-[3.75rem] mt-[6rem] font-sans font-[600] text-center tracking-normal leading-[5rem] text-[#67DF87]">First crypto application to have<br />more than 1 million users</p>
        <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-x-6 mt-[3rem] mb-[1rem]">
          ...
          <Card img={User.src} title="Number of Wallets" number="10.6M"/>
