...
const index = () => {
    ...
    return (
        ...
        <div className= "bg-[#1dc5b7] py-[10rem] xl:px-[22rem] lg:px-[7rem] md:px-[4rem] px-[2rem] ">
            ...
            <div className="lg:flex md:flex hidden justify-between lg:px-[7rem]  py-5">
                <div className="flex flex-col text-left w-[65%] space-y-[3rem] ">
                    ...
                    ready to prioritise human experiences over unauthorised data usage and advertising frauds?</p>
            ...
            <div className="lg:hidden md:hidden flex justify-between lg:px-[7rem]  py-5">
                <div className="flex flex-col text-left space-y-[2rem] ">
