...
const index = () => {
    ...
    return (
        ...
        <div className="bg-[#800080] pt-[5rem]  ">
            ...
            <div className="flex  xl:px-[22rem] lg:px-[7rem] px-[3rem]">
                <div className="justify-center w-[60%] space-y-[5rem] pt-[1rem] xl:px-[22rem]">
                    
                    <p className="ml-[2.5rem] text-left font-[300] pl-[9rem] pt-[10rem] lg:text-[4.5rem] lg:leading-[0rem] md:text-[2rem] md:leading-[0rem] text-[#FFFFFF]">
                    REWARDS SHOP
                    </p>
