...
const index = () => {
    ...
    return (
        ...
        <div className="bg-[#681dea] py-[10rem] xl:px-[22rem] lg:px-[7rem] md:px-[4rem] px-[2rem]">
                ...
                <div className="flex flex-col text-left w-[65%] space-y-[3rem] ">
                    ...
                    <div className="flex justify-start items-left">
                        ...
                        <div className=" grid gap-x-8  grid-cols-1">
                            ...
                            <Card title1="rewards" title2="additional reward tokens, exclusive ambassador NFTs" />
            ...
            <div className="lg:hidden md:hidden flex justify-center lg:px-[7rem] px-[1rem] py-5">
                <div className="flex flex-col text-left  space-y-[3rem] ">
                    ...
                    <button onClick={() => openInNewTab('https://docs.google.com/forms/d/e/1FAIpQLSdRCS1T45mEvvgbY_-j0esPbXM4F-_AG_z7CgDlzYST_9Wwdw/viewform?usp=pp_url&entry.407278199=https://')} className="rounded-[2rem] bg-[#ffffff]   p-5 space-y-5 ">
                        <p className="text-[1.5rem] font-[500]  tracking-normal leading-[1.5rem] text-[#333333]">Become an ambassador</p>
                    </button>
