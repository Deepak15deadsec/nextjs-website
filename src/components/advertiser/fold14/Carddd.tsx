...
import Flag from "../../../../public/images/mission.png";
    ...
    <div className="rounded-[1rem] bg-[#2EB7F5]   p-6 space-y-5 w-full h-full">
      ...
      <div className="flex space-x-4 justify-center">
        ...
        <div className="space-y-[0.15rem] ">
          <p className="text-[2.1rem] font-sans font-[600] text-center  tracking-normal leading-[2rem] text-[#FFFFFF]">Do the impossible</p>
