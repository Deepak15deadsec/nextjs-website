  ...
  return (
    ...
    <div className="bg-[#FF6154] flex py-[2rem] justify-between xl:px-[22rem] lg:px-[7rem] md:px-[4rem] px-[2rem]">
      ...
      <div className="grid xs:grid-cols-1 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-[7rem] mb-[9rem]">
        ...
        <Cardx img={Boxx.src} content="We take your privacy and security seriously and ensure that all your personal and transactions datas are encrypted, and no data is shared with any agenies or advertisers. it is secured so there’s no room for mistakes." title="What's yours remains only yours." />
